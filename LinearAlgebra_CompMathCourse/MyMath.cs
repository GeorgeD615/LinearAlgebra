...
namespace MyMathematica
{
    public class MyMath
    {
        ...
        public static void SLAE(Matrix A, Matrix b, out Vector X)
        {
            ...
            int rank = MatrixRank(A, out Matrix Q, out Matrix P);
        ...
        public static int MatrixRank(Matrix A, out Matrix Q, out Matrix P)
        {
            ...
            //    {
            //        if(Math.Abs(A[i, row]) > Math.Abs(maxVal))
            //        {
            //            maxVal = A[i, row];
            //            maxInd = i;
            //        }
            ...
            //    for (int i = row; i < A.GetLength(1); ++i)
            //    {
            //        if (Math.Abs(A[row, i]) > Math.Abs(maxVal))
            //        {
            //            maxVal = A[row, i];
            //            maxInd = i;
            //        }
            ...
            //    A.SwapColumns(maxInd, row);

            //    if (!MyMath.DoubleCompare(A[row, row], 0))
            //    {
        ...
        public static void SeidelMethod(Matrix A, Matrix b, out Vector X)
        {
            int n = A.GetLength(0);
            X = new Vector(n);
